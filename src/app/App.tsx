...
const ORG_CARD_NAME_FONT_SIZE = 14 / MM2_ORG_CHART_SCALE;
...
export const members = [
  { id: 1,  no: "N26431021", loginId: "hmc0810",      name: "한미채", type: "일반",  regDate: "2026-06-08", status: "정상", rank: "멤버",  grade: "멤버",  phone: "010-0000-0000", ssn: "701129-2000123", region: "서울 강남" },
  { id: 2,  no: "N26482827", loginId: "kr7841",        name: "황기봉", type: "일반",  regDate: "2026-05-14", status: "정상", rank: "멤버",  grade: "멤버",  phone: "010-1111-2222", ssn: "530419-2000456", region: "상주 마공" },
  { id: 3,  no: "N26081224", loginId: "lsb8579",       name: "황찬하", type: "일반",  regDate: "2026-04-20", status: "정상", rank: "멤버",  grade: "멤버",  phone: "010-2222-3333", ssn: "470220-1000789", region: "부산 해운대" },
  { id: 4,  no: "N26614351", loginId: "Mjr2893",       name: "홍세라", type: "일반",  regDate: "2026-03-15", status: "정상", rank: "준회원", grade: "준회원", phone: "010-3333-4444", ssn: "650511-2000111", region: "경기 의정부" },
  { id: 5,  no: "N26455673", loginId: "ljh5891",       name: "김성남", type: "일반",  regDate: "2026-02-28", status: "정상", rank: "준회원", grade: "준회원", phone: "010-4444-5555", ssn: "601101-1000222", region: "서울 신릉" },
  { id: 6,  no: "N26414074", loginId: "hyunju7158",    name: "이숙련", type: "일반",  regDate: "2026-01-10", status: "정상", rank: "멤버",  grade: "멤버",  phone: "010-5555-6666", ssn: "960501-2000333", region: "서울 신릉" },
  { id: 7,  no: "N26783741", loginId: "yys0767",       name: "장은경", type: "일반",  regDate: "2025-12-05", status: "정상", rank: "멤버",  grade: "멤버",  phone: "010-6666-7777", ssn: "070427-4000444", region: "인천 부평" },
  { id: 8,  no: "N26648797", loginId: "n_myworld9722", name: "방지유", type: "일반",  regDate: "2025-11-22", status: "정상", rank: "준회원", grade: "준회원", phone: "010-7777-8888", ssn: "940802-2000555", region: "뉴시아04" },
  { id: 9,  no: "N26445001", loginId: "lky6000",       name: "엄진희", type: "소비자", regDate: "2025-10-18", status: "탈퇴", rank: "탈퇴자", grade: "멤버",  phone: "",             ssn: "999999-9999999", region: "광주 수완" },
  { id: 10, no: "N26950500", loginId: "Jkh3890",       name: "김소유", type: "일반",  regDate: "2025-09-30", status: "정상", rank: "멤버",  grade: "준회원", phone: "010-3641-3800", ssn: "701222-1000666", region: "광주 수완" },
  { id: 11, no: "N26905000", loginId: "pos3684",       name: "박옥순", type: "일반",  regDate: "2025-08-14", status: "정상", rank: "준회원", grade: "준회원", phone: "010-5551-3600", ssn: "550136-2000777", region: "경기 양주" },
  { id: 12, no: "N26403500", loginId: "Bcs0122",       name: "방옥순", type: "일반",  regDate: "2025-07-03", status: "정상", rank: "핀플",  grade: "핀플",  phone: "010-5493-9000", ssn: "990122-2000888", region: "시아이350" },
  { id: 13, no: "N26848528", loginId: "ijlee77",       name: "이인자", type: "소비자", regDate: "2025-06-20", status: "정상", rank: "멤버",  grade: "멤버",  phone: "010-3456-7890", ssn: "650620-2000999", region: "경기 성남" },
  { id: 14, no: "N26445650", loginId: "ksjung",        name: "정경선", type: "일반",  regDate: "2025-05-11", status: "정상", rank: "준회원", grade: "준회원", phone: "010-4567-8901", ssn: "720511-2000121", region: "서울 송파" },
  { id: 15, no: "N26521742", loginId: "gelee",         name: "이가은", type: "일반",  regDate: "2025-04-08", status: "정상", rank: "멤버",  grade: "멤버",  phone: "010-5678-9012", ssn: "880408-2000232", region: "대전 유성" },
  { id: 16, no: "N26683868", loginId: "mrshin",        name: "신미라", type: "일반",  regDate: "2025-03-25", status: "정상", rank: "멤버",  grade: "멤버",  phone: "010-6789-0123", ssn: "790325-2000343", region: "부산 사하" },
  { id: 17, no: "N26454707", loginId: "mskim",         name: "김묘신", type: "일반",  regDate: "2025-02-14", status: "정상", rank: "준회원", grade: "준회원", phone: "010-7890-1234", ssn: "660214-2000454", region: "울산 남구" },
  ...
  { id: 21, no: "10002769", loginId: "kr2132670",    name: "남현영", type: "일반",  regDate: "2025-12-22", status: "정상", rank: "디렉터+", grade: "퍼플", phone: "010-7922-3612", ssn: "650706-2100817", region: "김해" },
];
...
function buildOrderSampleData(member: Member) {
  const headerRows = [
    ...
    },
    {
      ...
      deductNo: "D202604018",
      deductStatus: "신고완료",
      orderNo: "O20260501003",
      orderDate: "2026-05-01",
      allowanceDate: "2026-05-15",
      plan: "프리미엄",
      purchaseType: "구매",
      orderStatus: "출고완료",
      cash: "0",
    ...
    },
    {
      ...
      deductNo: "D202604012",
      deductStatus: "신고완료",
      orderNo: "O20260422004",
      orderDate: "2026-04-22",
      allowanceDate: "2026-05-01",
      plan: "일반",
      purchaseType: "구매",
      orderStatus: "출고완료",
      cash: "19,999",
    ...
    },
    {
      ...
      deductNo: "D202603031",
      deductStatus: "신고완료",
      orderNo: "O20260328006",
      orderDate: "2026-03-28",
      allowanceDate: "2026-04-01",
      plan: "기본플랜",
      purchaseType: "교환",
      orderStatus: "출고완료",
      cash: "0",
    ...
    },
    {
      ...
      deductNo: "D202602015",
      deductStatus: "신고완료",
      orderNo: "O20260220008",
      orderDate: "2026-02-20",
      allowanceDate: "2026-03-01",
      plan: "프리미엄",
      purchaseType: "구매",
      orderStatus: "출고완료",
      cash: "0",
    ...
    },
    {
      ...
      deductNo: "D202601008",
      deductStatus: "신고완료",
      orderNo: "O20260130009",
      orderDate: "2026-01-30",
      allowanceDate: "2026-02-01",
      plan: "일반",
      purchaseType: "반품",
      orderStatus: "반품완료",
      cash: "0",
    ...
    },
    {
      ...
      deductNo: "D202512044",
      deductStatus: "신고완료",
      orderNo: "O20251218010",
      orderDate: "2025-12-18",
      allowanceDate: "2026-01-01",
      plan: "기본플랜",
      purchaseType: "구매",
      orderStatus: "출고완료",
      cash: "0",
    ...
    },
    {
      ...
      deductNo: "D202511021",
      deductStatus: "신고완료",
      orderNo: "O20251105011",
      orderDate: "2025-11-05",
      allowanceDate: "2025-12-01",
      plan: "일반",
      purchaseType: "구매",
      orderStatus: "출고완료",
      cash: "0",
    ...
    },
    {
      ...
      deductNo: "D202510014",
      deductStatus: "신고완료",
      orderNo: "O20251020012",
      orderDate: "2025-10-20",
      allowanceDate: "2025-11-01",
      plan: "기본플랜",
      purchaseType: "구매",
      orderStatus: "출고완료",
      cash: "30,000",
    ...
    },
    {
      ...
      deductNo: "D202509007",
      deductStatus: "신고완료",
      orderNo: "O20250912013",
      orderDate: "2025-09-12",
      allowanceDate: "2025-10-01",
      plan: "일반",
      purchaseType: "구매",
      orderStatus: "출고완료",
      cash: "0",
  ...
  const lineRows = [
    ...
    {
      no: 3,
      bundleNo: "B20260508002",
      orderStatus: "배송중",
      shipType: "택배",
      deliveryType: "일반배송",
      warehouse: "부산센터",
      shipDate: "2026-05-10",
      productCode: "P-CL-003",
      productName: "콜라겐 앰플",
      uniqueNo: "U00018510",
      price: "180,000",
      qty: "1",
    ...
    {
      no: 5,
      bundleNo: "B20260501003",
      orderStatus: "출고완료",
      shipType: "직배",
      deliveryType: "당일배송",
      warehouse: "서울센터",
      shipDate: "2026-05-02",
      productCode: "P-PM-001",
      productName: "프리미엄 케어세트",
      uniqueNo: "U00018601",
      price: "450,000",
      qty: "1",
    },
    {
      no: 6,
      bundleNo: "B20260422004",
      orderStatus: "출고완료",
      shipType: "택배",
      deliveryType: "일반배송",
      warehouse: "대구센터",
      shipDate: "2026-04-24",
      productCode: "P-SK-021",
      productName: "스킨케어 토너",
      uniqueNo: "U00018688",
      price: "69,999",
      qty: "1",
    ...
    {
      no: 9,
      bundleNo: "B20260315007",
      orderStatus: "출고완료",
      shipType: "택배",
      deliveryType: "일반배송",
      warehouse: "인천센터",
      shipDate: "2026-03-17",
      productCode: "P-HL-007",
      productName: "헬스케어 멀티팩",
      uniqueNo: "U00018755",
      price: "260,000",
      qty: "1",
    },
    {
      no: 10,
      bundleNo: "B20260220008",
      orderStatus: "출고완료",
      shipType: "택배",
      deliveryType: "일반배송",
      warehouse: "서울센터",
      shipDate: "2026-02-22",
      productCode: "P-PM-002",
      productName: "프리미엄 기프트박스",
      uniqueNo: "U00018802",
      price: "380,000",
      qty: "1",
    },
...
function buildAllowanceSampleData(member: Member) {
  const headerRows = [
    ...
    {
      no: 2,
      issueName: "2026년 04월 수당",
      post: "게시",
      payDate: "2026-05-01",
      memberNo: member.no,
      memberName: member.name,
      occurrenceTotal: "980,000",
      returnDeduct: "20,000",
      otherDeduct: "5,000",
      deductTotal: "25,000",
      allowanceTotal: "955,000",
      withdrawal: "400,000",
      gift: "50,000",
      productPurchase: "100,000",
      points: "20,000",
      fee: "12,000",
      balance: "373,000",
    },
    {
      no: 3,
      issueName: "2026년 03월 수당",
      post: "게시",
      payDate: "2026-04-01",
      memberNo: member.no,
      memberName: member.name,
      occurrenceTotal: "1,100,000",
      returnDeduct: "0",
      otherDeduct: "8,000",
      deductTotal: "8,000",
      allowanceTotal: "1,092,000",
      withdrawal: "600,000",
      gift: "0",
      productPurchase: "150,000",
      points: "25,000",
      fee: "14,000",
      balance: "303,000",
    },
    {
      no: 4,
      issueName: "2026년 02월 수당",
      post: "게시",
      payDate: "2026-03-01",
      memberNo: member.no,
      memberName: member.name,
      occurrenceTotal: "870,000",
      returnDeduct: "30,000",
      otherDeduct: "0",
      deductTotal: "30,000",
      allowanceTotal: "840,000",
      withdrawal: "300,000",
      gift: "0",
      productPurchase: "80,000",
      points: "18,000",
      fee: "10,000",
      balance: "432,000",
    },
    {
      no: 5,
      issueName: "2026년 01월 수당",
      post: "게시",
      payDate: "2026-02-01",
      memberNo: member.no,
      memberName: member.name,
      occurrenceTotal: "1,420,000",
      returnDeduct: "80,000",
      otherDeduct: "15,000",
      deductTotal: "95,000",
      allowanceTotal: "1,325,000",
      withdrawal: "700,000",
      gift: "100,000",
      productPurchase: "250,000",
      points: "40,000",
      fee: "18,000",
      balance: "217,000",
    },
  ...
  const lineRows = [
    ...
    },
    {
      ...
      memberNo: member.no,
      memberName: member.name,
      providerNo: "N26422110",
      providerName: "박지현",
      allowanceTypeNo: "A205",
      allowanceTotal: "435,000",
      memo: "후원 수당",
      createdAt: "2026-05-01 09:05",
      createdBy: "system",
      name: member.name,
    },
    {
      ...
      providerName: "김성남",
      allowanceTypeNo: "A101",
      allowanceTotal: "610,000",
      memo: "직접판매 수당",
      createdAt: "2026-04-01 09:08",
      createdBy: "system",
      name: member.name,
    },
    {
      ...
      providerNo: "N26414074",
      providerName: "이숙련",
      allowanceTypeNo: "A310",
      allowanceTotal: "482,000",
      memo: "매칭 수당",
      createdAt: "2026-04-01 09:08",
      createdBy: "system",
      name: member.name,
    },
    {
      ...
      memberNo: member.no,
      memberName: member.name,
      providerNo: "N26433201",
      providerName: "최유진",
      allowanceTypeNo: "A101",
      allowanceTotal: "840,000",
      memo: "직접판매 수당",
      createdAt: "2026-03-01 09:11",
      createdBy: "system",
      name: member.name,
    },
    {
      ...
      providerName: "김성남",
      allowanceTypeNo: "A101",
      allowanceTotal: "725,000",
      memo: "직접판매 수당",
      createdAt: "2026-02-01 09:03",
      createdBy: "system",
      name: member.name,
    },
    {
