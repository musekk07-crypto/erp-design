        ...
        <FormSection title="로그인 사용정보" icon={<Shield size={12} />}>
          <table className="content-form-grid content-form-grid--6 content-form-grid--member" style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              ...
              <tr className="form-row--solo">
                <td style={{ padding: "3px 10px 3px 0", whiteSpace: "nowrap", verticalAlign: "middle" }}>
                  <span style={{ fontSize: "12px", color: "var(--form-label-color)", fontWeight: 500 }}>전자메일주소</span>
                </td>
                <td colSpan={5} style={{ padding: "3px 10px 3px 0", verticalAlign: "middle" }}>
          ...
          <table className="content-form-grid content-form-grid--6" style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style={{ padding: "3px 0 3px 0", verticalAlign: "middle" }}>
                  <span style={{ fontSize: 12, padding: "3px 10px", background: "var(--badge-status-active-bg)", color: "var(--accent-primary)", border: "1px solid var(--accent-border)", borderRadius: 4, whiteSpace: "nowrap", display: "inline-flex", alignItems: "center", gap: 4 }}>
                    ✓ 인증완료
                  </span>
                </td>
              </tr>
