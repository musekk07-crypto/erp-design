...
function Sidebar({ activeNavKey, onNavChange, theme, onThemeChange }: SidebarProps) {
  return (
    <div
      ...
      style={{ width: SIDEBAR_WIDTH, minWidth: SIDEBAR_WIDTH, height: "100%", background: "var(--sidebar-bg, #333333)", borderRight: "1px solid var(--nav-border, var(--border))", flexShrink: 0 }}
    >
      <div className="flex flex-col items-center gap-1 flex-1">
        {navItems.map((item) => (
          <SidebarNavButton
