            ...
            {sorted.map((member) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={{ ...cellBase, fontSize: 11, color: "#94a3b8" }}>{member.id}</td>
                  <td style={{ ...cellBase, fontSize: 11, fontFamily: "monospace", color: isSelected ? "#7c3aed" : "#1e2130", fontWeight: isSelected ? 600 : 400 }}>{member.no}</td>
                  <td style={{ ...cellBase, fontSize: 11, color: "#475569" }}>{member.loginId}</td>
                  <td style={{ ...cellBase, fontSize: 11, color: isSelected ? "#7c3aed" : "#1e2130", fontWeight: isSelected ? 600 : 500 }}>{member.name}</td>
                  <td style={{ ...cellBase }}>
                    <span style={{ fontSize: 11, padding: "2px 7px", borderRadius: 4, background: member.type === "소비자" ? "#cffafe" : "#f1f5f9", color: member.type === "소비자" ? "#0891b2" : "#64748b" }}>{member.type}</span>
                  </td>
                  <td style={{ ...cellBase, fontSize: 11, color: "#64748b" }}>{member.regDate}</td>
                  <td style={{ ...cellBase }}>
                    <span style={{ fontSize: 11, padding: "2px 7px", borderRadius: 4, background: member.status === "탈퇴" ? "#fee2e2" : "#dcfce7", color: member.status === "탈퇴" ? "#dc2626" : "#16a34a" }}>{member.status}</span>
                  </td>
                  <td style={{ ...cellBase, fontSize: 11, color: "#475569" }}>{member.rank}</td>
                  <td style={{ ...cellBase, fontSize: 11, color: "#475569" }}>{member.grade}</td>
                  <td style={{ ...cellBase, fontSize: 11, color: "#475569", fontFamily: "monospace" }}>{member.phone}</td>
                  <td style={{ ...cellBase, fontSize: 11, color: "#94a3b8", fontFamily: "monospace" }}>{member.ssn}</td>
                  <td style={{ ...cellBase, fontSize: 11, color: "#475569" }}>{member.region}</td>
                </tr>
              );
            })}
          </tbody>
