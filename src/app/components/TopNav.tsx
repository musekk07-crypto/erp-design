      ...
      <div className="flex items-center px-4" style={{ background: "var(--nav-bg, #1a0a6b)", borderBottom: "1px solid var(--nav-border, #140854)", height: 44 }}>
        <div className="flex items-center gap-2 mr-6">
          <div
            ...
            style={{ width: 28, height: 28, background: "var(--logo-bg, #7c3aed)", fontSize: 10, fontWeight: 700, color: "#fff" }}
          >
            VB
          </div>
        ...
        <div className="flex items-center gap-3 ml-4">
          ...
          <div
            ...
            style={{ width: 26, height: 26, background: "#4f7ef8", fontSize: 10, fontWeight: 700, color: "#fff" }}
          >
            디
          </div>
