    ...
    <div style={{ flexShrink: 0 }}>
      ...
      <div className="flex items-center px-4" style={{ background: "var(--nav-bg, #0f1d32)", borderBottom: "1px solid var(--nav-border, #0a1526)", height: 44 }}>
        <div className="flex items-center gap-2 mr-6">
          <div
            ...
            style={{ width: 28, height: 28, background: "var(--logo-bg, #001673)", fontSize: "var(--font-size-xs)", fontWeight: 700, color: "#fff" }}
          >
            VB
          </div>
        ...
        <div className="flex items-center gap-3 ml-4">
          <div
            className="flex items-center justify-center rounded"
            style={{ width: 26, height: 26, background: "var(--nav-avatar-bg, rgba(255,255,255,0.2))", fontSize: "var(--font-size-xs)", fontWeight: 600, color: "var(--nav-text, #fff)" }}
          >
            KR
          </div>
          <div
            className="flex items-center justify-center rounded-full"
            style={{ width: 26, height: 26, background: "#4f7ef8", fontSize: "var(--font-size-xs)", fontWeight: 700, color: "#fff" }}
          >
            디
          </div>
          ...
          <button style={{ fontSize: "var(--font-size-md)", color: "var(--nav-text-muted, rgba(255,255,255,0.7))" }}>로그아웃</button>
        </div>
      </div>
      ...
      >
        ...
        <button
          ...
          style={{ fontSize: "var(--font-size-sm)", fontWeight: 500, background: "var(--accent-light)", color: "var(--accent-primary)", border: "none" }}
        >
          회원등록
        </button>
      </div>
